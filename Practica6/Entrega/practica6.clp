...
(defmodule usuario (declare (auto-focus TRUE)) )
...
(defmodule ciudad (declare (auto-focus TRUE)))
...
(defrule ocioso
    ...
    (printout t "Añadido ocio a " ?n crlf))
...
(defmodule destino (declare (auto-focus TRUE)))
...
(defmodule transporte (declare (auto-focus TRUE)))
...
(defmodule alojamiento (declare (auto-focus TRUE))  )
